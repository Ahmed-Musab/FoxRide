...
const COLUMNS = [
  { key: 'vehicleNo', label: 'Vehicle No', width: 110 },
  { key: 'alertType', label: 'Alert Type', width: 130 },
  { key: 'alertName', label: 'Alert Name', width: 110 },
...
const TABLE_DATA = [
  {
    vehicleNo: 'MP31V1234',
    alertType: 'Wheel Alignment',
    alertName: 'Oil Change',
    date: '12/05/2026',
    status: 'Active',
  },
  {
    vehicleNo: 'MP31V5678',
    alertType: 'Tyre Pressure',
    alertName: 'Low Tyre Pressure',
    date: '22/05/2026',
    status: 'Active',
  },
  {
    vehicleNo: 'MP31V9101',
    alertType: 'Meter Reading',
    alertName: 'Reading every first day of the month',
    date: '30/05/26',
    status: 'Active',
  },
];
