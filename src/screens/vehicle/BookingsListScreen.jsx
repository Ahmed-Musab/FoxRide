...
const COLUMNS = [
  { key: 'bookingID', label: 'Booking ID', width: 110 },
  { key: 'employee', label: 'Employee', width: 130 },
  { key: 'bookingType', label: 'Booking Type', width: 110 },
  { key: 'status', label: 'Status', width: 80 },
  { key: 'assignedDriver', label: 'Assigned Driver', width: 110 },
  { key: 'driverContact', label: 'Driver Contact', width: 90 },
  { key: 'assignedVehicle', label: 'Assigned Vehicle', width: 120, badge: true },
  { key: 'assignmentType', label: 'Assignment Type', width: 120, badge: true },
  { key: 'rideStatus', label: 'Ride Status', width: 120 },
  { key: 'multipleDayBooking', label: 'Multiple Day Booking', width: 110 },
  { key: 'toDateTime', label: 'To Date/Time', width: 110 },
  { key: 'selfDriving', label: 'Self Driving', width: 110 },
  { key: 'rentedCar', label: 'Rented Car', width: 110 },
...
const TABLE_DATA = [
  {
    ...
    bookingType: 'Ahmed',
    status: 'Approved',
    assignedDriver: 'Owais',
    driverContact: '03330226330',
    assignedVehicle: 'Car',
    assignmentType: 'Official',
    rideStatus: 'Pending',
    multipleDayBooking: 'Yes',
    toDateTime: '20/12/2024',
    selfDriving: 'Yes',
    rentedCar: 'No',
    allowanceStaff: 'No',
  },
